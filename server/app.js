...
*/
  ...
  app.get('/api/conversations', ensureAuthenticated, function(req, res) {
    ...
    var conversations = [
      ...
      { name: '#ESIEA', parameterized_name: 'ESIEA', type: 'channel', channel: 'conversation_channel_ESIEA' },
      { name: '#Ivry sur Seine', parameterized_name: 'VilleIvrysurSeine', type: 'channel', channel: 'conversation_channel_VilleIvrysurSeine' },
      { name: '#ESIEA TECH DAY', parameterized_name: 'ESIEATECHDAY', type: 'channel', channel: 'conversation_channel_ESIEATECHDAY' },
      { name: '#JO Paris 2024', parameterized_name: 'JOParis2024', type: 'channel', channel: 'conversation_channel_JOParis2024' },
      { name: '#Élection présidentielle', parameterized_name: 'Électionprésidentielle', type: 'channel', channel: 'conversation_channel_Électionprésidentielle' }
